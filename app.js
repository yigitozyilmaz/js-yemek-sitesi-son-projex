...
//function render(arr_) {
// if (arr_.length > 0) {
//   arr_.map((items) => {
const itemsBox = document.createElement("div");
itemsBox.className = "menu-items";

const imageBox = document.createElement("img");
imageBox.src = items.img;
imageBox.className = "photo";

const infoBox = document.createElement("div");
infoBox.className = "menu-info";
...
desc.innerText = items.desc;
desc.className = "menu-text";

itemsBox.appendChild(imageBox);
itemsBox.appendChild(infoBox);
infoBox.appendChild(titleContainer);
